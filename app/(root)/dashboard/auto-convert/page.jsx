...
const AutoConvertPage = () => {
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-600">Loading Automation...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div ref={containerRef} className="p-4 sm:p-8 lg:p-12 max-w-5xl mx-auto min-h-screen">
      {/* Stepper */}
        ...
        <div className="flex items-center w-full max-w-3xl px-4">
          {steps.map((step, i) => (
            <React.Fragment key={step.id}>
              ...
              {i < steps.length - 1 && (
                <div className="flex-1 h-[1px] mx-2 bg-white/5 relative">
                  <div 
      ...
      <div className="animate-up text-center mb-12 mt-12">
        <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 mb-6">
          ...
          <span className="text-[9px] font-black text-primary uppercase tracking-widest">Automation Engine v2.0</span>
        </div>
        ...
        <p className="text-zinc-500 font-medium max-w-2xl mx-auto text-sm leading-relaxed">
          Automatically convert affiliate links in your video descriptions to smart links.
          Boost your earnings with geo-targeting and advanced analytics in seconds.
        </p>
      </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="flex items-center space-x-4 mb-8">
              ...
              <div>
                ...
                <p className="text-xs font-medium text-zinc-500 uppercase tracking-widest">Step 1 of 5</p>
              </div>
            </div>

            <p className="text-zinc-400 text-sm mb-10 leading-relaxed font-medium">
              We need permission to read and update your video descriptions. This uses YouTube's official OAuth API to ensure secure and authorized access to your channel metadata.
            </p>
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-center space-x-4">
                ...
                <span className="group-hover:text-white transition-colors">Connect YouTube Account</span>
              </div>
            </button>
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-5">
                  <li className="flex items-start space-x-4 text-xs text-zinc-400 font-medium group">
                    ...
                    <span>Read your video descriptions to find affiliate links</span>
                  </li>
                  <li className="flex items-start space-x-4 text-xs text-zinc-400 font-medium group">
                    <CheckCircle2 className="w-4 h-4 text-green-500 shrink-0 transition-transform group-hover:scale-110" />
                    <span>Replace raw affiliate links with geo-targeted smart links</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="mt-12 pt-8 border-t border-white/5">
              ...
              >
                <ChevronDown className={`w-3 h-3 transition-transform duration-500 ${isExpanding ? "rotate-180" : ""}`} />
              ...
              {isExpanding && (
                <div className="mt-6 text-xs text-zinc-500 leading-relaxed font-medium pl-6 border-l border-primary/20">
                  To automatically replace your existing affiliate links with smart links, we require write access specifically for video metadata. This allows Linkflin to process your video descriptions in bulk, saving you hours of manual work and ensuring your links are always up to date.
                </div>
              )}
            </div>
              ...
              <div className="space-y-6 relative z-10">
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-[9px] font-black text-zinc-600 uppercase tracking-widest">Before Processing</span>
                  </div>
                  <p className="text-xs text-zinc-500 font-medium italic pl-3 border-l border-zinc-800">
                    ...check out this camera <span className="text-zinc-600 underline decoration-zinc-800 underline-offset-4">https://amazon.com/dp/B0XXXXX?tag=creator-20</span>
                  </p>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <div className="w-1 h-1 bg-primary rounded-full shadow-[0_0_5px_rgba(148,153,232,1)]" />
                    <span className="text-[9px] font-black text-primary uppercase tracking-widest">After Conversion</span>
                  </div>
                  <p className="text-xs text-white font-medium pl-3 border-l border-primary/30">
                    ...check out this camera <span className="text-primary font-black underline decoration-primary/40 underline-offset-4">https://linkflin.io/sony-a7iv</span>
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="animate-up flex flex-wrap items-center justify-center gap-12 opacity-30 hover:opacity-60 transition-opacity duration-1000 mb-20">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-[9px] font-black uppercase tracking-[0.2em]">OAuth 2.0 Secure</span>
        </div>
        <div className="flex items-center space-x-3">
          <RefreshCcw className="w-4 h-4 text-primary" />
          <span className="text-[9px] font-black uppercase tracking-[0.2em]">Bulk Processing</span>
        </div>
        <div className="flex items-center space-x-3">
          <Sparkles className="w-4 h-4 text-primary" />
          <span className="text-[9px] font-black uppercase tracking-[0.2em]">AI detection</span>
        </div>
      </div>
    </div>
  );
