      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="flex items-center space-x-3">
              <div className="relative w-8 h-8">
                ...
                <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8 text-white relative z-10">
                  <path d="M12 3V21M3 12H21M18.5 5.5L5.5 18.5M18.5 18.5L5.5 5.5" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
                  <path d="M15 9L12 6L9 9M15 15L12 18L9 15" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
            ...
            <p className="text-zinc-500 font-medium text-sm leading-relaxed max-w-xs">
              Smart links for YouTube creators. Geo-targeted, app-opening, always monitored.
            </p>
          </div>
        ...
        <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-xs font-medium text-zinc-600">
            Copyright © 2026 Youfiliate
          </p>
          <div className="flex items-center space-x-8">
            <Link href="#" className="text-xs font-medium text-zinc-600 hover:text-white transition-colors">
              Privacy Policy
            </Link>
            <Link href="#" className="text-xs font-medium text-zinc-600 hover:text-white transition-colors">
              Terms & Conditions
