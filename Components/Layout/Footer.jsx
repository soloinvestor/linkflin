...
import { GitBranch, Twitter, Linkedin, Instagram } from "lucide-react";
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-20">
          <div className="space-y-10">
            ...
            <div className="flex space-x-5">
              {[Twitter, GitBranch, Linkedin, Instagram].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-zinc-500 hover:text-white hover:bg-white/10 transition-all border border-white/5">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-12">
              <div>
                <h3 className="text-[10px] font-black leading-6 text-white uppercase tracking-[0.2em] mb-8">Platform</h3>
                <ul role="list" className="space-y-4">
                  {["Smart Routing", "Deep Linking", "Analytics", "API Docs"].map((item) => (
                    <li key={item}>
                      <a href="#" className="text-sm font-medium text-zinc-500 hover:text-white transition-colors">{item}</a>
                    </li>
                  ))}
                </ul>
              </div>
              <div className="mt-12 md:mt-0">
                <h3 className="text-[10px] font-black leading-6 text-white uppercase tracking-[0.2em] mb-8">Resources</h3>
                <ul role="list" className="space-y-4">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-12">
              <div>
                <h3 className="text-[10px] font-black leading-6 text-white uppercase tracking-[0.2em] mb-8">Company</h3>
                <ul role="list" className="space-y-4">
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-[10px] font-black leading-6 text-white uppercase tracking-[0.2em] mb-8">Legal</h3>
                <ul role="list" className="space-y-4">
