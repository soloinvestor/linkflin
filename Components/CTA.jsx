  ...
  return (
    <section className="py-32 relative">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Decorative Glows */}
          <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#9499e8]/30 blur-[120px] rounded-full -z-10" />
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <button className="text-lg font-bold text-white flex items-center group px-8 py-5">
                Contact Sales <ArrowRight className="ml-3 h-5 w-5 transition-transform group-hover:translate-x-2 text-[#9499e8]" />
              </button>
            </div>
            <div className="mt-16 pt-8 border-t border-white/5 flex flex-wrap justify-center gap-x-12 gap-y-4">
              {["No credit card", "Free forever tier", "Instant setup"].map((item) => (
                <div key={item} className="flex items-center space-x-3">
                  <div className="w-5 h-5 rounded-full bg-[#9499e8]/20 flex items-center justify-center">
                    <CheckCircle2 className="h-3 w-3 text-[#9499e8]" />
                  </div>
